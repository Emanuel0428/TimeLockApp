        ...
        <div className="max-w-md mx-auto w-full">
          ...
          <div className="bg-linear-to-br from-[#131F37]/85 to-[#0F172A]/85 rounded-2xl p-6 mb-6 border border-white/10">
            ...
            <p className="text-sm text-[#94A3B8] leading-relaxed mb-4">
              Los tokens te permiten adelantar el proceso de desbloqueo de
              aplicaciones bloqueadas. Cada token te da 1 hora de uso sin
              restricciones.
            </p>
            <p className="text-sm text-[#94A3B8] leading-relaxed">
              Gana tokens completando desafíos, manteniendo buenos hábitos
              digitales o alcanzando tus objetivos de concentración.
            </p>
          </div>
          ...
          <div className="bg-linear-to-br from-[#131F37]/85 to-[#0F172A]/85 rounded-2xl p-6 mb-6 border border-white/10">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3 p-3 bg-[#1E293B] rounded-lg">
                ...
                <div className="flex-1">
                  <p className="text-sm font-medium text-[#F8FAFC]">
                    Cumple tus objetivos diarios
                  </p>
                  <p className="text-xs text-[#94A3B8]">
                    7 días seguidos = 5 tokens
                  </p>
                </div>
              </div>
            </div>
          ...
          >
            {tokenBalance > 0 ? "Usar token" : "No tienes tokens disponibles"}
          </button>

          {/* Mensaje adicional */}
          <p className="text-center text-xs text-[#94A3B8] mt-4">
            Usa tus tokens con sabiduría. Úsalos solo cuando realmente los
            necesites.
          </p>
